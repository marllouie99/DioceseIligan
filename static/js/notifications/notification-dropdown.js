...
class NotificationDropdownModule {
  ...
  init() {
    try {
      if (this.isInitialized) {
        console.warn('NotificationDropdownModule already initialized');
        return true;
      }
      ...
      console.log('NotificationDropdownModule initialized successfully');
      return true;
    } catch (error) {
  ...
  sanitizeHTML(html) {
    try {
      ...
      console.warn('sanitizeHTML failed, using raw html');
      return String(html);
    }
  }
