...
urlpatterns = [
    ...
    path('manage-church/<int:church_id>/followers-list/', views.get_church_followers_list, name='get_church_followers_list'),
    path('manage-church/<int:church_id>/add-staff/', views.add_church_staff, name='add_church_staff'),
